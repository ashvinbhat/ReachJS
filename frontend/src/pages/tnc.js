export default function Tnc() {
  return (
    <div className="tnc">
      ...
      <p>Welcome to ReachJS!</p>

      <p>
        These terms and conditions outline the rules and regulations for the use
        of ReachJS's Website, located at idk.
      </p>

      <p>
        By accessing this website we assume you accept these terms and
        conditions. Do not continue to use ReachJS if you do not agree to take
      ...
      <p>
        We employ the use of cookies. By accessing ReachJS, you agreed to use
        cookies in agreement with the ReachJS's Privacy Policy.{" "}
      </p>
      ...
      <p>
        Unless otherwise stated, ReachJS and/or its licensors own the
        intellectual property rights for all material on ReachJS. All
        intellectual property rights are reserved. You may access this from
        ReachJS for your own personal use subjected to restrictions set in these
        terms and conditions.
      </p>

      <p>You must not:</p>
      <ul>
        <li>Republish material from ReachJS</li>
        <li>Sell, rent or sub-license material from ReachJS</li>
        <li>Reproduce, duplicate or copy material from ReachJS</li>
      ...
      <p>
        ...
        ReachJS does not filter, edit, publish or review Comments prior to their
        presence on the website. Comments do not reflect the views and opinions
        of ReachJS,its agents and/or affiliates. Comments reflect the views and
        opinions of the person who post their views and opinions. To the extent
        permitted by applicable laws, ReachJS shall not be liable for the
      ...
      <p>
        ReachJS reserves the right to monitor all Comments and to remove any
      ...
      <p>
        You hereby grant ReachJS a non-exclusive license to use, reproduce, edit
      ...
      <p>
        ...
        the hyperlink compensates the absence of ReachJS; and (d) the link is in
      ...
      <p>
        ...
        e-mail to ReachJS. Please include your name, your organization name,
      ...
      <p>
        No use of ReachJS's logo or other artwork will be allowed for linking
